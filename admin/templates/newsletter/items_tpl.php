...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
			...
			<?php }  else { ?>
            	<li class="current"><a href="#" onclick="return false;">Quản lý danh sách <?=$title_main?></a></li>
            <?php } ?>
        </ul>
        <div class="clear"></div>
    </div>
...
<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
	...
	<tr style="text-align:center">
        ...
        <td style="width:20%;" align="center"><b><?=$items[$i]['hoten']?></b></td>
        <td style="width:20%;" align="center"><b><?=$items[$i]['email']?></b></td>
		
		<td class="actBtns" style="width:20%;">
			<a href="index.php?com=newsletter&act=edit&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" title="" class="smallButton tipS" original-title="Sửa"><img src="./images/icons/dark/pencil.png" alt=""></a>
			<a href="index.php?com=newsletter&act=delete&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" title="" class="smallButton tipS" original-title="Xoá" onClick="if(!confirm('Xác nhận xóa')) return false;"><img src="./images/icons/dark/close.png" alt=""></a>
