...
function get_main_list() {
    ...
    $str='
      	<select id="id_list" name="id_list" data-level="0" data-type="'.$_GET['type'].'" data-table="table_album_cat" data-child="id_cat" class="main_select select_danhmuc">
...
function get_main_cat(){
  	global $item;
    $sql="select * from table_album_cat where id_list='".$item['id_list']."' and type='".$_GET['type']."' order by stt asc";
    $stmt=mysql_query($sql);
    $str='
      	<select id="id_cat" name="id_cat" data-level="1" data-type="'.$_GET['type'].'" data-table="table_album_item" data-child="id_item" class="main_select select_danhmuc">
			...
			<?php if($config_images == 'true'){?>
				...
				<?php if($_GET['act']=='edit'){?>
					<div class="formRow">
						...
						<div class="formRight">
							<div class="mt10">
								<img src="<?=_upload_album.$item['thumb']?>"  alt="NO PHOTO" width="100" />
							</div>
						</div>
						<div class="clear"></div>
					</div>
