		...
		<div class="widget">
			...
			<?php if($config_icon=='true'){ ?>
				<div class="formRow">
					...
					<div class="formRight">
						...
						<div class="note"> width : 130px , Height : 130px </div>
					</div>
					<div class="clear"></div>
				</div>
				<?php if($_GET['act']=='edit'){?>
					<div class="formRow">
						...
						<div class="formRight">
							<div class="mt10"><img src="<?=_upload_baiviet.$item['icon']?>"  alt="NO PHOTO" width="50" /></div>
						</div>
						<div class="clear"></div>
					</div>
				<?php } ?>
			...
			<?php if($_GET['type']=='bds') { ?>
			    ...
			    <div class="formRow">
			        <label>Liên hệ</label>
			        <div class="formRight">
			          	<input type="text" name="sdtlienhe" title="Nhập số điện thoại liên hệ" id="sdtlienhe" class="tipS" value="<?=@$item['sdtlienhe']?>" />
			        </div>
			        <div class="clear"></div>
			    </div>
			<?php } ?>

	<!-- BEGIN Nhận xét của khách hàng -->
			<?php if($_GET['type']=='nhanxet') { ?>
				<div class="formRow lang_hidden lang_vi active">
			        <label>Tên học viên</label>
			        <div class="formRight">
			          	<input type="text" name="ten_vi" title="Nhập tên khách hàng" id="ten_vi" class="tipS validate[required]" value="<?=@$item['ten_vi']?>" />
			        </div>
			        <div class="clear"></div>
			    </div>
			    <div class="formRow lang_hidden lang_en">
			      	<label>Tên học viên (Tiếng anh)</label>
			      	<div class="formRight">
			        	<input type="text" name="ten_en" title="Nhập tên khách hàng" id="ten_en" class="tipS validate[required]" value="<?=@$item['ten_en']?>" />
			      	</div>
			      	<div class="clear"></div>
			    </div>
			    <div class="formRow">
			    ...
			    <?php if($_GET['act']=='edit'){?>
			  	...
			  	<?php } ?>
			  	<div class="formRow lang_hidden lang_vi active">
			      	<label>Cảm nhận của học viên</label>
			      	<div class="formRight">
			          	<textarea rows="4" cols="" title="Nhập cảm nhận của học viên" class="tipS" name="mota_vi"><?=@$item['mota_vi']?></textarea>
			      	</div>
			      	<div class="clear"></div>
			    </div>
			    <div class="formRow lang_hidden lang_en">
			      	<label>Cảm nhận của học viên (Tiếng anh)</label>
			      	<div class="formRight">
			            <textarea rows="4" cols="" title="Nhập cảm nhận của học viên" class="tipS" name="mota_en"><?=@$item['mota_en']?></textarea>
			      	</div>
			      	<div class="clear"></div>
			    </div>
			<?php } ?>
	<!-- END Nhận xét của khách hàng -->
			...
			<?php if($_GET['type'] == 'visao'){ ?>
				<div class="formRow">
					<label>Số liệu</label>
					<div class="formRight">
		                <input type="text" name="solieu" title="Nhập số liệu" id="solieu" class="conso tipS" value="<?=@$item['solieu']?>"/>
					</div>
					<div class="clear"></div>
				</div>
			<?php } ?>

			<?php if($config_mota == 'true' && $_GET['type'] != 'gioithieu'){ ?>
				<div class="formRow lang_hidden lang_vi active">
					<label>Mô tả</label>
					<div class="formRight">
			...
			<?php if($config_mota == 'true' && $_GET['type'] == 'gioithieu'){ ?>
				<div class="formRow lang_hidden lang_vi active">
					<label>Mô tả</label>
					<div class="ck_editor">
		                <textarea id="mota_vi" rows="4" cols="" title="Nhập mô tả . " class="tipS" name="mota_vi"><?=@$item['mota_vi']?></textarea>
					</div>
					<div class="clear"></div>
				</div>
				<div class="formRow lang_hidden lang_en">
					<label>Mô tả (Tiếng Anh)</label>
					<div class="ck_editor">
		                <textarea id="mota_en" rows="4" cols="" title="Nhập mô tả . " class="tipS" name="mota_en"><?=@$item['mota_en']?></textarea>
					</div>
					<div class="clear"></div>
				</div>
				<div class="formRow lang_hidden lang_cn">
					<label>Mô tả (Tiếng Trung)</label>
					<div class="ck_editor">
		                <textarea id="mota_cn" rows="4" cols="" title="Nhập mô tả . " class="tipS" name="mota_cn"><?=@$item['mota_cn']?></textarea>
					</div>
					<div class="clear"></div>
				</div>
			<?php } ?>
			...
			<?php if($config_noidung == 'true') { ?>
				...
				<div class="formRow lang_hidden lang_cn">
					<label>Nội dung chi tiết (Tiếng Trung)</label>
					<div class="ck_editor">
			...
			<?php if($_GET['type'] == 'pctour') { ?>
				<div class="formRow lang_hidden lang_vi active">
					<label>Tour Overview</label>
					<div class="ck_editor">
		                <textarea id="noidung_vi" name="noidung_vi"><?=@$item['noidung_vi']?></textarea>
					</div>
					<div class="clear"></div>
				...
				<div class="formRow lang_hidden lang_vi active">
					...
					<div class="ck_editor">
		                <textarea id="tab2" name="tab2"><?=@$item['tab2']?></textarea>
					</div>
					<div class="clear"></div>
				</div>
				<div class="formRow lang_hidden lang_vi active">
					...
					<div class="ck_editor">
		                <textarea id="tab3" name="tab3"><?=@$item['tab3']?></textarea>
					</div>
					<div class="clear"></div>
				</div>
				<div class="formRow lang_hidden lang_vi active">
					...
					<div class="ck_editor">
		                <textarea id="tab4" name="tab4"><?=@$item['tab4']?></textarea>
					</div>
					<div class="clear"></div>
				</div>
			<?php } ?>
