<?php
	...
	$price_item = number_format(get_price($product, $q)*$q,0, ',', '.')." &nbsp;VND ";
	$dongia = number_format(get_price($product, $q),0, ',', '.')." &nbsp;VND ";
	$full_item = number_format(get_order_total(),0, ',', '.')." &nbsp;VND ";
	$get_order_info = array('price_item' => $price_item ,'full_item' => $full_item,'amount_item' => $soluong,'dongia' => $dongia);
